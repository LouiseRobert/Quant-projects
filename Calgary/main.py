...
API_FQDN = "api-capital.backend-capital.com" #"demo-api-capital.backend-capital.com"
TICKER = "GOLD"
...
def main_nightbot():
    """
    Le bot va attendre les horaires de nuit pour travailler. 
    """
    ...
    while True:
        ...
        if 0 <= now.hour < 9:
            ...
            if positions == []:
                ...
                if rsi_cross_high and (current_rsi < 60):
                    print("SELL")
                ...
                elif rsi_cross_low and (current_rsi > 40):
                    print("BUY")
